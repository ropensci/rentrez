...
```{r pubmed_search, message=FALSE, warning=FALSE, comment=NA, cache=TRUE}
...
```{r entrez_link, message=FALSE, warning=FALSE, comment=NA, cache=TRUE}
...
```{r entrez_summary, message=FALSE, warning=FALSE, comment=NA, cache=TRUE}
...
```{r entrez_fetch, message=FALSE, warning=FALSE, comment=NA, cache=TRUE}
...
```{r webenvs1, message=FALSE, warning=FALSE, comment=NA, cache=TRUE}
...
```{r webenvs2, message=FALSE, warning=FALSE, comment=NA, cache=TRUE}
...
```{r webenvs3, message=FALSE, warning=FALSE, comment=NA, cache=TRUE}
