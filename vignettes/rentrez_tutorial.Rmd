...
asthma_snps <- entrez_link(dbfrom="omim", db="clinvar", cmd="neighbor_history", web_history=upload)
asthma_snps
```
...
snp_links <- entrez_link(dbfrom="clinvar", db="snp", 
                         web_history=asthma_snps$web_histories$omim_clinvar,
                         cmd="neighbor_history")
snp_summ <- entrez_summary(db="snp", web_history=snp_links$web_histories$omim_snp)
