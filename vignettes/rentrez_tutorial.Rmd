...
were `r count_recs("pubmed",1e6)` million papers in [PubMed](https://www.ncbi.nlm.nih.gov/pubmed/),
including `r count_recs("pmc", 1e6)` million full-text records available in [PubMed Central](https://www.ncbi.nlm.nih.gov/pubmed/).
[The NCBI Nucleotide Database](https://www.ncbi.nlm.nih.gov/nuccore) (which includes GenBank) has data for `r count_recs("nuccore", 1e6)`
...
species in the [NCBI taxonomy](https://www.ncbi.nlm.nih.gov/taxonomy) or `r count_recs("omim", 1e3)` thousand disease-associated records
...
databases](https://www.ncbi.nlm.nih.gov/home/documentation.shtml) and for the
